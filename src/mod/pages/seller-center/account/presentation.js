...
export default class SellerCenterPresentation extends Component {
    ...
    return (
      <Form>
        ...
        <FormItem
          ...
          label="账户可取现余额"
        >
          <span style={{marginRight: 20}}>55.00元</span>
        ...
        >
          <Button type="primary" htmlType="submit">
            <Link to='/seller-center/account/presentation?result=1'>提交</Link>
          </Button>
        </FormItem>
      </Form>
    )
  ...
  renderInfo = ()=>{
    ...
    return (
      <div style={{width: 250, margin: '0 auto', padding: '90px 0'}}>
        ...
        <div style={{textAlign: 'center'}}>
          <Button type="primary" htmlType="submit">
            <Link to='/seller-center/account/presentation'>继续提现</Link>
          </Button>
        </div>
      </div>
    )
